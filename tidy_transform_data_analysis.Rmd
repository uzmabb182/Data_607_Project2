...
## conneticut and Dalaware have hightest poverty count where as Wyoming and Wisconsin have the least
```{r}
ggplot(by_state, aes(fill=state, y=poverty_count, x=state)) +
  geom_bar(position='dodge', stat='identity')

```
## As the population increses, so in the poverty_count
## There is consistentincrease in the household_income and it is not effected by population
